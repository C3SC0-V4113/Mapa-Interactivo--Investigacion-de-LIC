...
import { getDepa } from "../features/departamento/depaSlice";
import * as Pais from "../public/El_Salvador_svg.svg";

function Main() {
  return (
    <>
      <div className="Division-Mapa">
        <svg
          version="1.2"
